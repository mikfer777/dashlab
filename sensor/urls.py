...
urlpatterns = [
    ...
    path('api/sensormodules/', views.SensorModuleListCreate.as_view(), name='sensormodules-list'),
    path('api/sensormodules/<sensormodule_id>/', views.SensorModuleDetail.as_view(), name='sensormodules-details'),
    path('api/sensormodules/<sensormodule_id>/sensordata/', views.SensorDataListCreate.as_view(), name='sensordata-list'),
    path('api//sensormodules/<sensormodule_id>/sensordata/<sensordata_id>/', views.SensorDataDetail.as_view(), name='sensordata-details'),
]
